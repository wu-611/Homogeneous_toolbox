function u=si_fho(h, z, y, A, C, f, L0, L, G0, nu1, nu2, alpha, beta)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% The function u=i_fh0(h,z,y,A,C,f,L0,L,G0,nu1,nu2) computes (updates)                   
...
%%
%%
%% The function u=si_fh0(h,z,y,A,C,f,L0,L,G0,nu1,nu2,alpha,beta)                   
...
if nargin>=13       
                     u=si_ho(h, z, y, A, C, f, L0, L, Gd, nu, alpha, beta);
  elseif nargin>=12  u=si_ho(h, z, y, A, C, f, L0, L, Gd, nu, alpha);
else                 u=si_ho(h, z, y, A, C, f, L0, L, Gd, nu);
end;
