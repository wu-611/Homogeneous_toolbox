function u=e_fhpc(x, K0, K, G0, mu1, mu2, P, alpha, beta)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% The function u=e_fhpc(x, K0, K, G0, mu1, mu2, P) computes                    
%%  parameters of Fixed-time Homogeneous Proportional Controller (FHCP)     
%%                                                                      
%%          _ 
%%         /
...
%%
%%
%% The function u=e_fhpc(x, K0, K, G0, mu1, mu2, P, alpha, beta)                    
...
if nargin==9        u=e_hpc(x,K0,K,Gd,mu,hn_fun,alpha,beta);
elseif nargin==8  u=e_hpc(x,K0,K,Gd,mu,hn_fun,alpha);
else                u=e_hpc(x,K0,K,Gd,mu,hn_fun);
end;
