"""
Semi-implicit discretization of Homogeneous Observer (HO).

Original MATLAB: si_ho.m

More stable than explicit Euler for stiff/oscillatory systems.
"""
...
def si_ho(h, z, y, A, C, f, L0, L, Gd, nu, alpha=1e-6, beta=np.inf):
    """
    One step of semi-implicit discretization of the Homogeneous Observer.

    Uses (I - h*(A + S*C))^(-1) instead of (I + h*(A + S*C)),
    providing better stability for stiff or oscillatory systems.
