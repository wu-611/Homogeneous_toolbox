...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  
%% Approximation of the canonical homogeneous norm
%%   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

rb=5;                                                                      % smoothing parameter

Q=approx_hnorm_r(Gd,P,rb,50);                                              % optimal selection of Q (needs YALMIP)

%Q=P;                                                                       % heuristic selection of Q   
...
set(plot2(1),'DisplayName','explicit homogeneous norm $\|x\|_{r}$',...
